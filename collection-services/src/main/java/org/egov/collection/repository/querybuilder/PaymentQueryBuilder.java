...
public class PaymentQueryBuilder {
	...
	public static final String WHATSAAP_ADOPTION_REPORT_QUERY ="select json_build_object ('id', pt.propertyid, 'tenantid', pt.tenantid,'consumercode',pt.propertyid,'usagecategory',pt.usagecategory, 'propertytype',pt.propertytype,'ownershipcategory',pt.ownershipcategory, "
